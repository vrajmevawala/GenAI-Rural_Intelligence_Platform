    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="p-2 rounded-lg bg-gray-50/50">
          <p className="text-[10px] text-gray-400 mb-0.5 uppercase tracking-wider">Primary crop</p>
          <p className="text-xs font-medium text-gray-700">{farmer.primary_crop || 'N/A'}</p>
        </div>
        <div className="p-2 rounded-lg bg-gray-50/50">
          <p className="text-[10px] text-gray-400 mb-0.5 uppercase tracking-wider">Land area</p>
          <p className="text-xs font-medium text-gray-700">{farmer.land_area_acres || 'N/A'} acres</p>
        </div>
        <div className="p-2 rounded-lg bg-gray-50/50">
          <p className="text-[10px] text-gray-400 mb-0.5 uppercase tracking-wider">Annual income</p>
          <p className="text-xs font-medium text-gray-700">
            {farmer.annual_income_inr ? formatCurrency(farmer.annual_income_inr) : '₹0'}
          </p>
        </div>
        <div className="p-2 rounded-lg bg-gray-50/50">
          <p className="text-[10px] text-gray-400 mb-0.5 uppercase tracking-wider">Language</p>
